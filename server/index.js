...
const ROUTES = [
  ...
  ['GET', /^\/api\/personas\/(?<id>\d+)\/sources$/, R.handleSourceList],
  ['POST', /^\/api\/personas\/(?<id>\d+)\/sources$/, R.handleSourceCreate],
  ['PUT', /^\/api\/sources\/(?<sid>\d+)$/, R.handleSourceUpdate],
  ['DELETE', /^\/api\/sources\/(?<sid>\d+)$/, R.handleSourceDelete],
